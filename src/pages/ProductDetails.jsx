    ...
    return (
      <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
        ...
        <main className="mx-auto max-w-4xl px-4 py-16 text-center">
          ...
          <Link
            to="/products"
            className="mt-6 inline-block rounded-2xl bg-[var(--nav)] px-6 py-3 font-semibold text-white"
          >
            Back to products
          </Link>
        </main>
          ...
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-8 shadow-sm">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="rounded-2xl border border-[var(--border)] bg-[var(--card)] px-6 py-3 font-semibold transition hover:-translate-y-0.5"
              >
                Visit Store
              </Link>
            </div>
